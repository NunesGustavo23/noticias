...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'jejum40dias@jejum40dias.com.br';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Jejum 40 dias';
   ...
   * @var string
   */
  public $Sender            = 'jejum40dias@jejum40dias.com.br';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'localhost;smtp.jejum40dias.com.br:587';
